...
description: "Research on spatial intelligence, human mobility, and urban systems."
description_zh: "围绕空间智能、人类出行行为与城市系统展开的研究。"
---
...
<div class="publication-list">{% for paper in site.data.publications %}{% include paper.html paper=paper %}{% endfor %}</div>
